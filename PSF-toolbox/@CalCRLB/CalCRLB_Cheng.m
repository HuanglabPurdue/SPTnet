...
classdef CalCRLB_Cheng < handle
    % CalCRLB_Cheng class for calculating CRLB of simulated emitters, given a PSF model defined by PRstruct
    %   create object: obj = CalCRLB_Cheng(PRstruct,PSFtype)
    ...
    %
    % CalCRLB_Cheng Properties (Implemented object):
    %   PSFobj - 
    %
    % CalCRLB_Cheng Properties (Input):
    %   Bg - 
    %   Boxsize - 
    %   Deltax - 
    %   Deltaz - 
    ...
    %   Zpos - 
    %
    % CalCRLB_Cheng Properties (Output):
    %   CRLB - 
    %   X_STD - 
    %   Y_STD - 
    %   Z_STD - 
    ...
    %   Bg_STD - 
    %
    % CalCRLB_Cheng Methods:
    %   prepInputparam - generate parameters of PSFs used for CRLB calculation
    %   CalCRLB_Cheng - calculate CRLB of simulated emitters, given a PSF model
    ...
    methods
        function obj = CalCRLB_Cheng(PRstruct,PSFtype)
            switch PSFtype
                case 'zernike'
